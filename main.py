...
def main():
    ...
    if success:
        ...
        print("- View node log: less ~/node/data/node.log")
        print("- Start node: goal node start")
        print("- Stop node: goal node stop") 
        print("- Restart node: goal node restart")
        print("\nTo monitor the node, run: python gui/monitor_gui.py")
        print("To manage node keys, run: python gui/key_manager_gui.py")
    else:
